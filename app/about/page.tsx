...
export const metadata: Metadata = {
  title: "About Us | Health Focus",
  description: "Empowering you with practical wellness advice grounded in science. Learn about our mission, approach, and editorial standards at Health Focus.",
};
      ...
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose-custom">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-8 text-neutral-700 dark:text-neutral-300">
            <li><strong>Evidence-Based Content</strong>: All advice is backed by peer-reviewed research</li>
            <li><strong>Practical Application</strong>: Tips you can actually use in real life</li>
            <li><strong>Realistic Expectations</strong>: No quick fixes or miracle cures</li>
            <li><strong>Transparency</strong>: Clear about what we know and don't know</li>
          </ul>
          ...
          <div className="p-6 bg-neutral-50 dark:bg-neutral-800 border-l-4 border-primary-600 my-6">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm text-neutral-700 dark:text-neutral-300">
              <li><strong>Expertise:</strong> Content is reviewed by accredited doctors.</li>
              <li><strong>Authoritativeness:</strong> We cite only peer-reviewed journals and medical institutions.</li>
              <li><strong>Trustworthiness:</strong> We maintain strict editorial independence and transparent sourcing.</li>
            </ul>
          </div>
